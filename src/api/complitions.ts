...
export const retirievAsistant = async () => {
  const assistant = await openai.beta.assistants.retrieve(
    "asst_dKiYwMFpkHUx1Gkl1leJtI6V"
  );
...
export const getCompletionsWithAssistant = async (
  assistantID: string,
  threadID: string,
  input: string
) => {
...
//   console.log("This is the Thread Message object: ", myThreadMessage, "\n");
  ...
  //   1. assistant created (assistantID)
  //   2. thread created (threadID)
  ...
  //   4. running assistant on created thread by using stored threadID and assisantID
  ...
  const waitForAssistantMessage = async () => {
    ...
    // console.log("User: ", myThreadMessage.content[0]);
